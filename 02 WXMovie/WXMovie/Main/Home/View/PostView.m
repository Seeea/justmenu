...
-(void)_createLightView{
    ...
    UIImageView *left = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"light"]];
    left.frame = CGRectMake(10, 0, 124, 204);
    
    UIImageView *right = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"light"]];
    right.frame = CGRectMake(kScreenWidth-10-124, 0, 124, 204);
